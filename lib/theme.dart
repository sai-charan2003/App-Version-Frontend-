...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      secondary: Color(4278210715),
      onSecondary: Color(4294967295),
      secondaryContainer: Color(4278285533),
      ...
      onSecondaryFixedVariant: Color(4278208138),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondaryFixed: Color(4278219996),
      onSecondaryFixed: Color(4294967295),
      secondaryFixedDim: Color(4278213552),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(4294967295),
      secondaryContainer: Color(4278207107),
      onSecondaryContainer: Color(4294967295),
      tertiary: Color(4278190080),
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4280690214),
      ...
      onPrimaryFixedVariant: Color(4294967295),
      secondaryFixed: Color(4278207107),
      onSecondaryFixed: Color(4294967295),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      onSecondary: Color(4278202466),
      secondaryContainer: Color(4278217676),
      onSecondaryContainer: Color(4294967295),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      secondaryContainer: Color(4282225147),
      ...
      secondaryFixedDim: Color(4289251583),
      onSecondaryFixedVariant: Color(4278204012),
      tertiaryFixed: Color(4293059298),
